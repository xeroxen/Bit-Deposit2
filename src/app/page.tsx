...
const Home = () => {
    ...
    return (
        <div className=" bg-gray-50 mt-10">
            ...
            <Link href="/support">
                <button className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full shadow-lg transition-all z-50 flex items-center justify-center gap-2 cursor-pointer">
